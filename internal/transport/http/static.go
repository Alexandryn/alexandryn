...
// real web/dist build's fs.FS will have. Swap the //go:embed directive
// above for the real build output once phase 04 lands (D2,
// tasks/plan.md); nothing else in this file needs to change.
...
// in tests — per backend-http-transport.md FR-8: a request matching a
...
// frontend-shell-and-routing.md's client-side routing needs, since a
...
// DefaultStaticHandler serves the embedded placeholder web/dist (D2).
