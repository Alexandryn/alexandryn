...
`../../reviews/0050-phase13-spec-package-and-phase12-authz-review.md`.
...
- **`docs/roadmap/12-authentication/README.md`** — post-close
...
- `CLAUDE.md`, `docs/constitution.md` (§1–§12, with §3/§4/§5/§6/§8/§9/§10/§11 load-bearing here)
- `docs/roadmap/13-network-access/README.md` (full phase doc — Scope In/Out, Exit criteria)
- `docs/decisions/0017-network-exposure-condition-gated.md` (**the rule this phase's bind logic enforces**)
- `docs/decisions/0025-jwt-session-mechanism.md` (phase 12's session mechanism — Bearer/JWT/localStorage, **no cookies**)
- `docs/decisions/0026-multi-library-tenancy-model.md`, `docs/decisions/0027-totp-mfa-implementation.md`
- `docs/specs/backend-configuration.md` FR-8 (`BIND_ADDRESS` classifier — already implemented, `internal/config/bindaddress.go`)
- `docs/specs/backend-http-transport.md` (middleware chain, FR-2 limits, `/healthz`/`/readyz`; CORS explicitly deferred to "phase 13's LAN story")
- `docs/specs/backend-authentication.md` (phase 12 — `APPROVED` 2026-09-02)
- `docs/specs/architecture-system.md` FR-3, FR-6 (same build, same origin), trust boundaries
- `docs/specs/frontend-shell-and-routing.md` FR-3/FR-4 (capability gating — `hostOnly()` gate already exists)
...
> `tasks/plan-phase13-network.md`
> and `tasks/todo-phase13-network.md`.
