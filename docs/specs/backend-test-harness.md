...
| | |
|---|---|
| **Status** | `APPROVED` (amended post-approval — container-target test coverage added, `0045`, needs maintainer re-confirmation) |
...
- **FR-8** The GitHub Actions workflow, as this phase's own deliverable,
  ...
  (`docs/roadmap/03-backend-foundation/README.md`'s own named CI
...
- `docs/roadmap/03-backend-foundation/README.md` — "coverage
