...
| **Supersedes** | — |
| **Reviewed in** | `.claude/reviews/0010-spec-architecture-contracts.md` — Approved with changes, all findings fixed; self-reviewed, independent read still pending |
...
- `docs/roadmap/03-backend-foundation/README.md` — owns the error
  taxonomy and contract-test tool implementation
- `docs/roadmap/06-library/README.md` — first real feature to exercise
  this contract
