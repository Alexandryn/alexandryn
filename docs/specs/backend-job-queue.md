...
| **Supersedes** | — |
| **Reviewed in** | `0036` (two independent agents, cross-spec) — Needs rework at review time (1 Blocking, confirmed independently by both; 6 Major), all findings fixed; approved by maintainer 2026-08-15 |
