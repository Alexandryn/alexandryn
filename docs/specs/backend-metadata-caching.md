...
| **Supersedes** | — |
| **Reviewed in** | `0034` (two independent agents, cross-spec) — Needs rework at review time (1 Blocking, confirmed independently by both; 8 Major, 2 confirmed independently by both), all findings fixed; approved by maintainer 2026-08-15 |
