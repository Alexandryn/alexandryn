...
| **Supersedes** | — |
| **Reviewed in** | `0018` (self) + `0021` (two independent agents, cross-spec) — both Approved with changes, all findings fixed; maintainer read and approved 2026-08-19; correctness pass `0048` |
...
- Constitution §3 (source is its own domain, never merged with
  ...
  specifically)
- `docs/roadmap/02-domain/README.md` — "source availability treated
