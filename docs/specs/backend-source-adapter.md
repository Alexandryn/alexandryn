...
| **Supersedes** | — |
| **Reviewed in** | `0035` (two independent agents, cross-spec) — Needs rework at review time (2 Blocking, 8 Major, 5 Minor), all findings fixed; approved by maintainer 2026-08-15. Amended post-approval, `0037` — FR-15 added, formalising `Provider.List` as a phase-10-reusable Go capability alongside the already-named `Provider.Resolve`, cross-spec-reviewed, re-confirmed by maintainer 2026-08-15 |
