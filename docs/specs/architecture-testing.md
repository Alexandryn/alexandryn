...
| **Supersedes** | — |
| **Reviewed in** | `.claude/reviews/0013-spec-architecture-testing.md` — Approved with changes, both findings fixed; self-reviewed, independent read still pending. FR-9 (gitleaks) and FR-10 (CodeQL) added 2026-08-18, maintainer-directed in the same session that decided them, self-reviewed, needs maintainer re-confirmation |
