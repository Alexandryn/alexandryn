...
export interface SegmentedControlProps
  extends Omit<ComponentPropsWithoutRef<typeof RadixRadioGroup.Root>, 'aria-label' | 'aria-labelledby'> {
  options: SegmentedControlOption[]
  'aria-label': string
}

/** Radix RadioGroup, styled as segments (FR-1) — roving-tabindex arrow-key navigation for free. */
export const SegmentedControl = forwardRef<ElementRef<typeof RadixRadioGroup.Root>, SegmentedControlProps>(
