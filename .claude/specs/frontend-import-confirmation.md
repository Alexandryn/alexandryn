...
| **Supersedes** | — |
| **Reviewed in** | [`0037`](../reviews/0037-phase10-cross-spec-review.md) (two independent agents, cross-spec) — Needs rework at review time (7 Blocking across the batch, each found by one pass; 11 Major, 6 Minor, 2 Nit), all findings fixed; awaiting maintainer approval |
