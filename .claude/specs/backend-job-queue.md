...
| **Supersedes** | — |
| **Reviewed in** | [`0036`](../reviews/0036-phase09-cross-spec-review.md) (two independent agents, cross-spec) — Needs rework at review time (1 Blocking, confirmed independently by both; 6 Major), all findings fixed; awaiting maintainer approval |
