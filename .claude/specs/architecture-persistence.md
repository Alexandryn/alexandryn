...
| **Supersedes** | — |
| **Reviewed in** | [`.claude/reviews/0009-spec-architecture-persistence.md`](../reviews/0009-spec-architecture-persistence.md) — Approved with changes, all findings fixed; self-reviewed, independent read still pending |
...
- **FR-4** Migrations MUST be forward-only. A migration MUST NOT be
  ...
  `.claude/decisions/README.md`'s ADR philosophy already applies to
