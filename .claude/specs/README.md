...
| [`backend-file-extractors.md`](backend-file-extractors.md) | Format detection, EPUB/PDF/CBZ extraction, adversarial-file defences | 10 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
| [`backend-import-pipeline.md`](backend-import-pipeline.md) | Discovery, import job handler, matching, auto-accept, confirm/reject, SourceOffering/LibraryEntry persistence | 10 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
| [`frontend-import-confirmation.md`](frontend-import-confirmation.md) | Resolution UI: pending candidates, suggested matches, confirm/reject, batch progress | 10 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
