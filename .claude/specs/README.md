...
| [`backend-library-api.md`](backend-library-api.md) | `/api/v1/library`, `/works/:id`, `/collections` endpoints, pagination, contract test tool | 06 | `REVIEWED` (independent, cross-spec, findings fixed — `0033`) |
| [`frontend-library-screens.md`](frontend-library-screens.md) | Library home, work detail: browse/search/filter/sort, real backend | 06 | `REVIEWED` (independent, cross-spec, findings fixed — `0033`) |
| [`frontend-collections-screens.md`](frontend-collections-screens.md) | Collections index/detail, create/rename/delete, membership | 06 | `REVIEWED` (independent, cross-spec, findings fixed — `0033`) |
