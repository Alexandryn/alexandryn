...
| [`backend-source-adapter.md`](backend-source-adapter.md) | Source CRUD, credential encryption, health checks, local-folder/OPDS providers, `/api/v1/sources*` | 08 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
| [`frontend-source-management.md`](frontend-source-management.md) | Source management screen: add/edit/remove, health status, browse/search | 08 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
