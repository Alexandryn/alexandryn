...
| [`backend-metadata-adapter.md`](backend-metadata-adapter.md) | Open Library client, rate limiting, normalisation, `/api/v1/discover*` | 07 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
| [`backend-metadata-caching.md`](backend-metadata-caching.md) | Local caching of normalised metadata and cover images | 07 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
| [`frontend-discover-screen.md`](frontend-discover-screen.md) | Discover screen: search, results, work detail, offline/degraded states | 07 | `REVIEWED` (independent review, findings fixed) — awaiting maintainer approval |
