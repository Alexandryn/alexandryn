...
| [0018](0018-phase99-release.md) | Phase 99 release surface — Electron packaging + fuses, Docker image/compose, release CI, OpenAPI contract auth annotations | 2026-09-17 | 0 | 0 | Clear — 3 findings (1 Medium, 1 Low, 1 High-as-documentation-defect), all fixed same session |
